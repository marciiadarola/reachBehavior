function [n_return,x_return]=plotExptOutput_selectTrials(tbt,excludePawOnWheelTrials,useTrials)
...
edges=-5:1:30;
[n_return,x_return]=histcounts(timesOfReach_starts,edges);
figure();
plot(x,n);
ma=max(n);
hold on;
