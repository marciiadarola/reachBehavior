function varargout = checkForReaches(varargin)
% CHECKFORREACHES MATLAB code for checkForReaches.fig
%      CHECKFORREACHES, by itself, creates a new CHECKFORREACHES or raises the existing
%      singleton*.
%
%      H = CHECKFORREACHES returns the handle to a new CHECKFORREACHES or the handle to
%      the existing singleton*.
%
%      CHECKFORREACHES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CHECKFORREACHES.M with the given input arguments.
%
%      CHECKFORREACHES('Property','Value',...) creates a new CHECKFORREACHES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before checkForReaches_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to checkForReaches_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help checkForReaches

% Last Modified by GUIDE v2.5 01-Jun-2017 11:47:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @checkForReaches_OpeningFcn, ...
                   'gui_OutputFcn',  @checkForReaches_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before checkForReaches is made visible.
function checkForReaches_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for checkForReaches
...
% Close all open figures except checkForReaches GUI
...
filename=varargin{1};
tbt=varargin{2}; % trial-by-trial data from plotCueTriggeredBehavior(finaldata,'cue')
...
% UIWAIT makes checkForReaches wait for user response (see UIRESUME)
...
function varargout = checkForReaches_OutputFcn(hObject, eventdata, handles) 
